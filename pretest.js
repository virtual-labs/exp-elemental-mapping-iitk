  ...
  const myQuestions = [
    {
      ...
      answers: {
        ...
        c: "Up to 0.1 – 1 µm  ",                  ///// Write the option 2 inside double quotes
        d: "Above few µm   ",                  ///// Write the option 2 inside double quotes
    ...
    
    {
     question: "3. Which compositional analysis can NOT be performed using X-ray energy dispersive spectroscopy ",  ///// Write the question inside double quotes
      answers: {
        ...
        c: "Bulk elemental analysis",                  ///// Write the option 2 inside double quotes
        d: "Monolayer elemental analysis ",                  ///// Write the option 2 inside double quotes
